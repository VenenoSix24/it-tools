        ...
        <a href="https://bit.ly/3zBl7DG" target="_blank" rel="noopener" class="text-current decoration-none">
          <c-card v-if="config.showSponsorBanner" class="cursor-pointer !border-2px !hover:border-primary">
            ...
            <div class="text-neutral-500 dark:text-neutral-400">
              Input an OpenAPI spec and generate developer documentation and SDKs with our sponsor <a href="https://bit.ly/3zBl7DG" target="_blank" rel="noopener" class="font-bold text-current transition hover:text-primary">Fern</a>. Request a preview <a href="https://bit.ly/3zBl7DG" target="_blank" rel="noopener" class="font-bold text-current transition hover:text-primary">here</a>.
            </div>
          </c-card>
        </a>
      </div>
